...
return [
    ...
    'files' => [
        'user/data/gantry5/themes/g5_hydrogen/config/_error' => [
            'index' => [
                'file' => 'user/data/gantry5/themes/g5_hydrogen/config/_error/index.yaml',
                'modified' => 1693338284
            ],
            'layout' => [
                'file' => 'user/data/gantry5/themes/g5_hydrogen/config/_error/layout.yaml',
                'modified' => 1693338284
            ]
        ],
    ...
    'data' => [
        ...
        'index' => [
            ...
            'particles' => [
                ...
                'copyright' => [
                    'copyright-3115' => 'Copyright'
                ],
                'branding' => [
                    'branding-1776' => 'Branding'
                ],
                'mobile-menu' => [
                    'mobile-menu-7830' => 'Mobile-menu'
                ]
            ],
            'inherit' => [
