...
return [
    ...
    'timestamp' => 1693576939,
    'checksum' => 'b40574d7fb7df3eb031ca08387e54788',
    'files' => [
        'user/themes/g5_hydrogen/particles' => [
            'particles/sample' => [
                'file' => 'user/themes/g5_hydrogen/particles/sample.yaml',
                'modified' => 1693297350
            ]
        ],
        ...
        'user/themes/g5_hydrogen/blueprints' => [
            'page' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/page.yaml',
                'modified' => 1693297349
            ],
            'styles/accent' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/accent.yaml',
                'modified' => 1693297349
            ],
            'styles/base' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/base.yaml',
                'modified' => 1693297349
            ],
            'styles/breakpoints' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/breakpoints.yaml',
                'modified' => 1693297349
            ],
            'styles/feature' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/feature.yaml',
                'modified' => 1693297349
            ],
            'styles/footer' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/footer.yaml',
                'modified' => 1693297349
            ],
            'styles/header' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/header.yaml',
                'modified' => 1693297349
            ],
            'styles/main' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/main.yaml',
                'modified' => 1693297349
            ],
            'styles/menu' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/menu.yaml',
                'modified' => 1693297349
            ],
            'styles/navigation' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/navigation.yaml',
                'modified' => 1693297349
            ],
            'styles/offcanvas' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/offcanvas.yaml',
                'modified' => 1693297349
            ],
            'styles/showcase' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/showcase.yaml',
                'modified' => 1693297349
            ],
            'styles/subfeature' => [
                'file' => 'user/themes/g5_hydrogen/blueprints/styles/subfeature.yaml',
                'modified' => 1693297349
            ]
        ],
    ...
    'data' => [
        'items' => [
            ...
            'pages.blog_item.header.redirect_default_route' => [
                'type' => 'toggle',
                'toggleable' => true,
                ...
                'name' => 'pages.blog_item.header.redirect_default_route',
                'validation' => 'loose'
            ],
            ...
            'pages.blog_list.header.redirect_default_route' => [
                'type' => 'toggle',
                'toggleable' => true,
                'label' => 'PLUGIN_ADMIN.REDIRECT_DEFAULT_ROUTE',
                'config-highlight@' => 'system.pages.redirect_default_route',
                ...
                'name' => 'pages.blog_list.header.redirect_default_route',
                'validation' => 'loose'
            ],
            ...
            'pages' => [
                'blog_item' => [
                    ...
                    'header' => [
                        ...
                        'redirect_default_route' => 'pages.blog_item.header.redirect_default_route',
                        'routes' => [
                ...
                'blog_list' => [
                    ...
                    'header' => [
                        ...
                        'redirect_default_route' => 'pages.blog_list.header.redirect_default_route',
                        'routes' => [
