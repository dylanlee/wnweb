...
/* @gantry-admin/pages/positions/item.html.twig */
class __TwigTemplate_986af748bc9d642d09c34f97d9616f378d90818d6efb6f391ea096ff5625c7aa extends \Twig\Template
{
    ...
    {
        // line 1
        $context["statuses"] = ["all" => ["label" => "Assigned to all", "icon" => "<i class=\"fa item-status fa-fw fa-circle\" aria-hidden=\"true\"></i>"], "none" => ["label" => "Not assigned", "icon" => "<i class=\"far item-status fa-fw fa-circle\" aria-hidden=\"true\"></i>"], "some" => ["label" => "Some assignments", "icon" => "<i class=\"fa item-status fa-fw fa-adjust\" aria-hidden=\"true\"></i>"]];
        // line 15
        echo "
<li data-pm-blocktype=\"";
    ...
    {
        return "@gantry-admin/pages/positions/item.html.twig";
    }
    ...
    {
        return new Source("", "@gantry-admin/pages/positions/item.html.twig", "/var/www/html/user/plugins/gantry5/admin/templates/pages/positions/item.html.twig");
    }
}
