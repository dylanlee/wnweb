...
class __TwigTemplate_078a8c4cf6f39f5c00a2796bb924a2d622372d6049c8e7f0030a3e8ff2b4b32c extends \Twig\Template
{
    ...
    public function block_input($context, array $blocks = [])
    {
        ...
        try {            // line 6
            ...
            <div>
                <span>";
            // line 13
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_LOGIN.2FA_SECRET"), "html", null, true);
            echo ": </span><span class=\"twofa-secret-code\" data-2fa-secret>";
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->regexReplace(($context["secret"] ?? null), "/(\\w{4})/", "\\1 "), "html", null, true);
            echo "</span>
            </div>
            ...
            <div class=\"danger twofa-wrapper\">
                <button data-hint=\"";
            // line 17
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_LOGIN.2FA_REGEN_HINT"), "html", null, true);
            echo "\" class=\"button button-small hint--bottom\" data-2fa-regenerate><i class=\"fa fa-fw fa-refresh\"></i> ";
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_LOGIN.2FA_REGENERATE"), "html", null, true);
            echo "</button>
            </div>
...
{% endblock %}
", "forms/fields/2fa_secret/2fa_secret.html.twig", "/var/www/html/user/plugins/login/templates/forms/fields/2fa_secret/2fa_secret.html.twig");
    }
}
